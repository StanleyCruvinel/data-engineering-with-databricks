...
# MAGIC
# MAGIC 5. Then, select number link in the table at the top in **Associated Jobs Ids** -> then the query number in **SQL/DataFrame Properties**. Here, you should see the entire query plan (DAG).
# MAGIC
