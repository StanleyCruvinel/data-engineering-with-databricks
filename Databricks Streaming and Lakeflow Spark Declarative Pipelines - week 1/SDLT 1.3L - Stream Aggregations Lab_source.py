...
# MAGIC            .format("delta")
# MAGIC            .load('/Volumes/dbacademy_ecommerce/v01/delta/events_hist'))
...
# MAGIC %skip
# MAGIC from pyspark.sql.functions import col, approx_count_distinct, count
# MAGIC
# MAGIC spark.conf.set("spark.sql.shuffle.partitions", spark.sparkContext.defaultParallelism)
# MAGIC
# MAGIC traffic_df = (events_df
# MAGIC               .groupBy("traffic_source")
# MAGIC               .agg(approx_count_distinct("user_id").alias("active_users"))
# MAGIC               .sort("traffic_source")
# MAGIC              )
...
# MAGIC %skip
# MAGIC traffic_query = (traffic_df
# MAGIC                  .writeStream
# MAGIC                  .queryName("active_users_by_traffic")
# MAGIC                  .format("memory")
