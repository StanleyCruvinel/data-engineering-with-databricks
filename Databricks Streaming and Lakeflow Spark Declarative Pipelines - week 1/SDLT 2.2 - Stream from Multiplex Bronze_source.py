...
# MAGIC
# MAGIC This notebook allows you to programmatically generate and trigger an update of a Lakeflow Spark Declarative pipeline that consists of the following notebooks:
# MAGIC
...
# spark.sql("DROP TABLE IF EXISTS dbacademy.labuser13429858_1768515742.date_lookup_clone")
# spark.sql("DROP TABLE IF EXISTS dbacademy.labuser13429858_1768515742.date_lookup")
