...
(spark.read  
              ...
              .select("user_id", "event_timestamp", "mobile", "device", "traffic_source")
           ).limit(10).display()
...
# MAGIC %md
# MAGIC
# MAGIC [lastProgress](https://spark.apache.org/docs/3.5.7/structured-streaming-programming-guide.html#managing-streaming-queries) gives us metrics from the previous query
...
# MAGIC %md
# MAGIC
# MAGIC [awaitTermination](https://spark.apache.org/docs/3.5.7/structured-streaming-programming-guide.html#managing-streaming-queries) 
